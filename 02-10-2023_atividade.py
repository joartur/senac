...
def jogar(limiteDeErros, numJogadores):
    print("Bem-vindo ao jogo Roda a Roda Jabuti!")
    ...
    while True:
        ...
        letras_escolhidas = []  # Lista para armazenar as letras já escolhidas
        ...
        while max(erros) < limiteDeErros and '_' in acertos:
            ...
            if len(letra) == 1:  # o usuário tentou adivinhar uma letra
